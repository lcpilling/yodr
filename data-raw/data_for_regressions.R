...
# example data from the excellent Framingham Heart Study
...
example_data = readr::read_csv("https://raw.githubusercontent.com/GauravPadawe/Framingham-Heart-Study/refs/heads/master/framingham.csv") |>
  janitor::clean_names() 
