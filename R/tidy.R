...
#' This function `tidy()` runs `broom::tidy()` and returns the tidy estimates with CIs 
...
#' Old tidy_ci function
#'
#' @describeIn tidy Alias for tidy
#' @export
tidy_ci <- function(x, ...) {
  lifecycle::deprecate_soft("1.0.0", "tidy_ci()", "tidy()")
  tidy(x, ...)
}
